...
class EventShow extends React.Component {
  ...
  let leaveButton = (<button
    onClick={() => this.props.deleteJoin(this.props.event.id)}
        ...
        <div className="show-content"> 
          <div className="sidebar">
            ...
            <div className="hoop-description">
              ...
              <h2>🍵</h2>
              <p>Basketball time is where ten-ish strangers meet at a basketball court with a Host to have a fun basketball game. It's not about anything in particular.</p>

              <p>You're meant to know pretty much nothing about the people that come, aside from the fact that they all signed up for this — just like you. It's self-selecting in that sense.</p>
